...
INSERT INTO `tbl_users` (`id`, `username`, `email`, `createtime`, `lastvisit`, `superuser`, `status`) VALUES
(1, 'admin@REALM', 'webmaster@example.com', 1261146094, 0, 1, 1),
(2, 'demo@REALM', 'demo@example.com', 1261146096, 0, 0, 1);
