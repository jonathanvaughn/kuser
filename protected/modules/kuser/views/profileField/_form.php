...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row varname">
		...
		<p class="hint"><?php echo KuserModule::t("Allowed lowercase letters and digits."); ?></p>
	</div>
	...
	<div class="row title">
		...
		<p class="hint"><?php echo KuserModule::t('Field name on the language of "sourceLanguage".'); ?></p>
	</div>
	...
	<div class="row field_type">
		...
		<p class="hint"><?php echo KuserModule::t('Field type column in the database.'); ?></p>
	</div>
	...
	<div class="row field_size">
		...
		<p class="hint"><?php echo KuserModule::t('Field size column in the database.'); ?></p>
	</div>
	...
	<div class="row field_size_min">
		...
		<p class="hint"><?php echo KuserModule::t('The minimum value of the field (form validator).'); ?></p>
	</div>
	...
	<div class="row required">
		...
		<p class="hint"><?php echo KuserModule::t('Required field (form validator).'); ?></p>
	</div>
	...
	<div class="row match">
		...
		<p class="hint"><?php echo KuserModule::t("Regular expression (example: '/^[A-Za-z0-9\s,]+$/u')."); ?></p>
	</div>
	...
	<div class="row range">
		...
		<p class="hint"><?php echo KuserModule::t('Predefined values (example: 1;2;3;4;5 or 1==One;2==Two;3==Three;4==Four;5==Five).'); ?></p>
	</div>
	...
	<div class="row error_message">
		...
		<p class="hint"><?php echo KuserModule::t('Error message when you validate the form.'); ?></p>
	</div>
	...
	<div class="row other_validator">
		...
		<p class="hint"><?php echo KuserModule::t('JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('file'=>array('types'=>'jpg, gif, png'))))); ?></p>
	</div>
	...
	<div class="row default">
		...
		<p class="hint"><?php echo KuserModule::t('The value of the default field (database).'); ?></p>
	</div>
	...
	<div class="row widget">
		...
		<p class="hint"><?php echo KuserModule::t('Widget name.'); ?></p>
	</div>
	...
	<div class="row widgetparams">
		...
		<p class="hint"><?php echo KuserModule::t('JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('param1'=>array('val1','val2'),'param2'=>array('k1'=>'v1','k2'=>'v2'))))); ?></p>
	</div>
	...
	<div class="row position">
		...
		<p class="hint"><?php echo KuserModule::t('Display order of fields.'); ?></p>
	</div>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? KuserModule::t('Create') : KuserModule::t('Save')); ?>
	</div>

<?php echo CHtml::endForm(); ?>

</div><!-- form -->
<div id="dialog-form" title="<?php echo KuserModule::t('Widget parametrs'); ?>">
	<form>
	<fieldset>
