...
class UWjuiAutoComplete {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>KuserModule::t('jQueryUI autocomplete',array(),__CLASS__),
			'fieldType'=>array('INTEGER'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'modelName'=>KuserModule::t('Model Name',array(),__CLASS__),
				'optionName'=>KuserModule::t('Lable field name',array(),__CLASS__),
				'emptyFieldLabel'=>KuserModule::t('Empty item name',array(),__CLASS__),
				'emptyFieldValue'=>KuserModule::t('Empty item value',array(),__CLASS__),
				'relationName'=>KuserModule::t('Profile model relation name',array(),__CLASS__),
				'minLength'=>KuserModule::t('minimal start research length',array(),__CLASS__),
			),
		);
	}
	...
	public function editAttribute($model,$field,$htmlOptions=array()) {
		...
		$basePath=Yii::getPathOfAlias('application.modules.kuser.views.asset');
