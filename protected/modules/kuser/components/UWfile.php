...
class UWfile {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>KuserModule::t('File field'),
			'fieldType'=>array('VARCHAR'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'path'=>KuserModule::t('Upload path'),
			),
	...
	public function editAttribute($model,$field,$params=array()) {
		...
		.' '.CHtml::activeLabelEx($model,'[uwfdel]'.$field->varname,array('label'=>KuserModule::t('Delete file'),'style'=>'display:inline;')):'')
		;
	}
